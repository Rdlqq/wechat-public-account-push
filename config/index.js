...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx77ad9e55772fc597',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a51c068e482d5cf53b1f136ea89f6614',
  ...
  USERS: [
    {
      ...
      id: 'owHxg5_KRdSFVMerUs0FLAy57krc',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '',
      // 所在省份
      province: '贵州',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '臭猪', year: '1998', date: '11-01',
        },
        {
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2022-07-26' },
        // 结婚纪念日
